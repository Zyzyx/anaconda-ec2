url --url=http://mirrors.yocum.org/fedora/releases/test/19-Beta/Fedora/x86_64/os/
# Without the Everything repo, we cannot install cloud-init
# Trying with F18 at the moment as F19 Everything does not yet exist
repo --name="fedora-everything" --baseurl=http://mirror.pnl.gov/fedora/linux/releases/18/Everything/x86_64/os/
install
graphical
vnc --password=fedoracloud
keyboard us
lang en_US.UTF-8
skipx
...
timeout=0
#hiddenmenu
title Fedora-19-ec2 ($LATEST_VER)
        root (hd0,0)
